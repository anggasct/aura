...
func TestMetricNamesPinned(t *testing.T) {
	metrics := map[string]string{
		...
		"MetricChildSpawnsTotal":      MetricChildSpawnsTotal,
		"MetricChildSettlesTotal":     MetricChildSettlesTotal,
		"MetricChildActive":           MetricChildActive,
		"MetricChildBudgetTokens":     MetricChildBudgetTokens,
		"MetricChildBudgetCost":       MetricChildBudgetCost,
